# MIGRATION TO TERRAFORM--Migrating or importing an already configured cloud resource, such as an instance, from an existing CloudFormation (CFT) stack into Terraform.
provider "aws" {
  region = ------
}
import {
